...
export default function Contact() {
  ...
  return (
    <section ref={elementRef} className={`min-h-screen py-8 lg:py-16 relative overflow-hidden transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
      }`}>
      ...
      <div className="max-w-[1200px] px-8 mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 lg:gap-16 items-start">
          ...
          <div className={`col-span-1 lg:col-span-3 transition-all duration-1000 ease-out ${isContentVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"
            }`}>
            {/* Location Arrow */}
          ...
          <div className={`col-span-1 lg:col-span-7 transition-all duration-1000 ease-out delay-300 ${isContentVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"
            }`}>
            <div className="bg-white rounded-lg p-6 lg:p-12 shadow-lg w-full max-w-4xl mt-16">
              {/* Form Title */}
